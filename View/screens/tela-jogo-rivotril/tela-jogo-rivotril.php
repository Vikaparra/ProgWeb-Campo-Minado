...
<head>
    ...
    <link rel="stylesheet" href="tela-jogo-rivotril.css">
    ...
    <title>Campo Minado - Rivotril</title>
</head>
...
<body onload="buildGridLayout()">
    ...
    <div id="container-principal" class="container">
        ...
        <aside>
            <div id="rivotril"><p>RIVOTRIL RIVOTRIL</p></div>
            ...
            <div id="config-jogo">
                ...
                <div>
                    <button id="sair-rivotril" class="general-button botao-sair-jogo">SAIR</button>
                </div>
            </div>
